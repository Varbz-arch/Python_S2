...
# 1. timing function execution (write in decorator that measure time a function takes to execute)
# 2. create a decorator to print the function name and the value of its arguments everytime the function is called
# 3. implement the decorator that caches the return value of a function so that when it is called with the same argument the cached value is return 
# instead of re exceuting the function
# 4. create a decorator that will validate input 
# 5. doc strings in python